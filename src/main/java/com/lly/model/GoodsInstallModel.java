...
public class GoodsInstallModel extends BaseModel {
    ...
    private Boolean installStatusCode;
    ...
    public Boolean getInstallStatusCode() {
        return installStatusCode;
    }

    public void setInstallStatusCode(Boolean installStatusCode) {
